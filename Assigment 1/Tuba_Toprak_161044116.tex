...
\begin{itemize}
	...
	\newline
	\newline
	Hypothesis: Countries with higher economy vaccinate more.
	\newline
How did I get the hypothesis: when we look at the poverty rate we can see that, for example, the poverty rate of the country of Benin: 49.6
The poverty rate of the country of Bulgaria: 1.5
\newline
\newline
Hypothesis: Countries with higher economy run more tests.
\newline
How did I get the hypothesis: we can see this when we look at the poverty rate
\newline
\newline
Hypothesis: Countries with high rates of economics have higher rates of aged 70 older
\newline
How did I get the hypothesis: when we look at the rate of aged 70 older, we can see this.For example, the rate of aged 70 older in Bangladesh: 3.2 poverty rate: 14.8
Greece's aged 70 older rate: 14.5 poverty rate: 1.5
\newline
\newline
Hypothesis: countries with high handwashing rates have fewer cases.
\newline
How did I get the hypothesis: for example, the handwashing rate for the country of armenia: 94, the handwash rate for the Mexico country: 87.8
\newline
\newline
Hypothesis: countries with higher rates of obesity have higher mortality rates
\newline
How I got the hypothesis: for example, if we look at the USA state and the country of zimbabwe, we can see this.
\newline
\newline
Hypothesis: smoking rates do not affect mortality rates.
\newline
How I got the hypothesis: for example, if we look at Argentina country and Congo country, we can see this.
\newline
\newline
Hypothesis: In rich countries hospital beds per thousand ratio is higher,
\newline
How I got the hypothesis: for example, if we look at Monaco country and Mali country, we can see this.
